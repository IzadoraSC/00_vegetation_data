...
## OBS: script não está completo, ainda gerando essa parte
...
img <- brick('outputs/rasters_crop/Wet_season_composite_PNCM-1985_crop.tif')
img <- brick('outputs/rasters_crop/Wet_season_composite_PNCM-2005_crop.tif')
img <- brick('outputs/rasters_crop/Wet_season_composite_PNCM-2020_crop.tif')

img1 <- brick('outputs/rasters_crop/Dry_season_composite_PNCM-1985_crop.tif')
img1 <- brick('outputs/rasters_crop/Dry_season_composite_PNCM-2005_crop.tif')
img1 <- brick('outputs/rasters_crop/Dry_season_composite_PNCM-2020_crop.tif')
...
#Landsat-5
indices <- ?spectralIndices(img1, red = 'B3', nir = 'B4', indices = c("NDVI",
                                                                    "NRVI",
                                                                    "MSAVI2",
                                                                    "SAVI",
                                                                    "KNDVI"))
...
indices1 <- spectralIndices(img1, green = 'B2', swir2 = 'B5', nir = 'B4',
